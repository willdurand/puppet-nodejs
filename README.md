...
* Since 2018 it's recommended to use version `2.0` of this package, full `2.x` development
  happens on master.

* For setups based on `1.9` bug fixes are still accepted for this branch.
